...
const Banner = ({ addCoins }) => {
    ...
    return (
        <div className='w-11/12 h-full p-20 m-10 blur-300px bg-[url(rb_2148971570)] bg-black items-center text-center '>
            <div className='flex justify-center'>
            <img className="max-w-full max-h-full" src="images/banner-main.png" alt="Banner Image" />
            </div>
            <h1 className='text-white font-bold text-4xl pt-4'>Assemble Your Ultimate Dream 11 Cricket Team</h1>
            <p className='text-white text-2xl pt-4 pb-6'>Beyond Boundaries Beyond Limits</p>
